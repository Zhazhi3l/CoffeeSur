...
namespace CoffeeSur.UI
{
    partial class FrmUsuario
    {
		...
		private void InitializeComponent()
		{
			...
			txtNombre.Location = new Point(220, 20);
			txtNombre.Margin = new Padding(3, 4, 3, 4);
			txtNombre.Name = "txtNombre";
			txtNombre.Size = new Size(504, 34);
			...
			txtApellido.Location = new Point(220, 20);
			txtApellido.Margin = new Padding(3, 4, 3, 4);
			txtApellido.Name = "txtApellido";
			txtApellido.Size = new Size(504, 34);
			...
			txtUser.Location = new Point(220, 20);
			txtUser.Margin = new Padding(3, 4, 3, 4);
			txtUser.Name = "txtUser";
			txtUser.Size = new Size(504, 34);
			txtUser.TabIndex = 15;
			// 
			// txtPassword
			// 
			...
			txtPassword.Location = new Point(220, 20);
			txtPassword.Margin = new Padding(3, 4, 3, 4);
			txtPassword.Name = "txtPassword";
			txtPassword.PasswordChar = '*';
			txtPassword.Size = new Size(504, 34);
			...
			cmbRol.Location = new Point(148, 20);
			cmbRol.Margin = new Padding(3, 4, 3, 4);
			cmbRol.Name = "cmbRol";
			cmbRol.Size = new Size(357, 29);
			cmbRol.TabIndex = 18;
			// 
			// chkActivo
			// 
			...
			chkActivo.Dock = DockStyle.Fill;
			chkActivo.Font = new Font("Footlight MT Light", 14.25F);
			chkActivo.Location = new Point(547, 20);
			chkActivo.Margin = new Padding(3, 4, 3, 4);
			chkActivo.Name = "chkActivo";
			chkActivo.Size = new Size(177, 40);
			...
			btnAceptar.Location = new Point(83, 27);
			btnAceptar.Margin = new Padding(3, 4, 3, 4);
			btnAceptar.Name = "btnAceptar";
			btnAceptar.Size = new Size(236, 62);
			...
			btnCancelar.Location = new Point(405, 27);
			btnCancelar.Margin = new Padding(3, 4, 3, 4);
			btnCancelar.Name = "btnCancelar";
			btnCancelar.Size = new Size(236, 62);
			...
			tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 10F));
			tableLayoutPanel1.Controls.Add(tableLayoutPanel8, 1, 7);
			...
			tableLayoutPanel2.Location = new Point(94, 38);
			...
			tableLayoutPanel4.Controls.Add(txtApellido, 2, 1);
			tableLayoutPanel4.Dock = DockStyle.Fill;
			tableLayoutPanel4.Location = new Point(94, 195);
